      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white dark:bg-neutral-900 rounded-t-[28px] w-full shadow-2xl border-t border-neutral-200 dark:border-neutral-800 overflow-hidden flex flex-col max-h-[90%]"
          >
