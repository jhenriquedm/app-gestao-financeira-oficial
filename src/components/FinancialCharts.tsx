...
export const FinancialCharts: React.FC<FinancialChartsProps> = ({
  ...
  return (
    <div id="financial-charts-wrapper" className="space-y-3 my-2">
      {/* Chart View Switcher (3 Equal Balanced Columns) */}
      <div className="grid grid-cols-3 bg-neutral-200/80 dark:bg-neutral-800/80 p-1 rounded-xl gap-1 border border-neutral-200/50 dark:border-neutral-700/60">
        <button
        ...
        >
          <PieIcon className="w-3.5 h-3.5 text-rose-600 dark:text-rose-400 shrink-0" />
      ...
      <div id="financial-charts-container" className="flex flex-col gap-3.5">
        ...
        {(mobileTab === 'monthly' || mobileTab === 'both') && (
          <div 
            ...
            className="w-full bg-white dark:bg-neutral-900 rounded-xl p-3 border border-neutral-200/90 dark:border-neutral-800 shadow-2xs flex flex-col justify-between transition-colors"
          >
