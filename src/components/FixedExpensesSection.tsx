...
export const FixedExpensesSection: React.FC<FixedExpensesSectionProps> = ({
  ...
  return (
    <div id="section-fixed-expenses-manager" className="space-y-4">
      {/* Top Banner Card */}
      <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 dark:from-indigo-700 dark:to-indigo-950 rounded-2xl p-4 text-white shadow-lg shadow-indigo-700/20 relative overflow-hidden">
