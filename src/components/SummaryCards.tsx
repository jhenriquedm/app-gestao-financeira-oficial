...
export const SummaryCards: React.FC<SummaryCardsProps> = ({ 
  ...
  return (
    <div id="summary-indicator-dashboard" className="space-y-2.5">
      ...
      {/* Executive Card de Saúde Financeira, Saldo do Mês e Comprometimento - Fixed/Sticky */}
      <div className="sticky top-0 z-20 pt-0.5 pb-1 -mt-1 bg-neutral-100/95 dark:bg-neutral-950/95 backdrop-blur-md">
        <div 
          ...
          className="bg-white dark:bg-neutral-900 rounded-xl p-3 border border-neutral-200/90 dark:border-neutral-800 shadow-sm relative overflow-hidden transition-colors"
        >
