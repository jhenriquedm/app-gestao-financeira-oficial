...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <div className="shrink-0 w-full z-40 px-3 pb-[calc(0.5rem+env(safe-area-inset-bottom,0px))] pt-1 bg-gradient-to-t from-neutral-100 dark:from-neutral-950 via-neutral-100/90 dark:via-neutral-950/90 to-transparent pointer-events-none">
      <nav
        id="mobile-bottom-dock"
        className="pointer-events-auto bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md border border-neutral-200/90 dark:border-neutral-750/90 rounded-2xl px-2 py-1 shadow-lg shadow-neutral-900/10 dark:shadow-black/50 transition-colors"
      >
