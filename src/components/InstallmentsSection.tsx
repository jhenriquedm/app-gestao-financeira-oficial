...
export const InstallmentsSection: React.FC<InstallmentsSectionProps> = ({
  ...
  return (
    <div id="section-installments-manager" className="space-y-4">
      {/* Top Banner Card: Visão Geral das Dívidas e Parcelamentos */}
      <div className="bg-gradient-to-br from-amber-600 to-amber-700 dark:from-amber-700 dark:to-amber-900 rounded-2xl p-4 text-white shadow-lg shadow-amber-700/20 relative overflow-hidden">
